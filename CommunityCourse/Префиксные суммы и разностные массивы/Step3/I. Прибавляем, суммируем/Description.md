# I. Прибавляем, суммируем

**ограничение по времени на тест:** 1.5 секунд  
**ограничение по памяти на тест:** 256 мегабайт

Есть массив целых чисел длины $n = 2^{24}$, изначально заполненных нулями. Индексация с нуля. Вам нужно сперва
обработать $m$ случайных запросов вида «прибавление на отрезке». Затем обработать $q$ случайных запросов вида «сумма на
отрезке».

### Входные данные

На первой строке числа $m$, $q$ ($1 \le m, q \le 2^{24}$). На второй строке пара целых чисел $a$, $b$ от $1$ до $10^9$,
